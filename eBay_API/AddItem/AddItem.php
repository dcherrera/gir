...
<TABLE cellpadding="2" border="0">
    ...
    <TR>
		<TD>startPrice</TD>
		<TD><INPUT type="text" name="startPrice" value="2"></TD>
	</TR>
    <TR>
		<TD>buyItNowPrice</TD>
		<TD><INPUT type="text" name="buyItNowPrice" value="10"> (set to 0.0 for Store)</TD>
	</TR>
    <TR>
		<TD>quantity</TD>
...
//		$requestXmlBody .= '<VerifyAddFixedPriceItemRequest xmlns="urn:ebay:apis:eBLBaseComponents">';
		...
		$requestXmlBody .= '<Item>';
		$requestXmlBody .= '<ConditionDescription> string </ConditionDescription>';
		$requestXmlBody .= '    <PickupInStoreDetails> PickupInStoreDetailsType';
		$requestXmlBody .= '      <EligibleForPickupDropOff> boolean </EligibleForPickupDropOff>';
		$requestXmlBody .= '      <EligibleForPickupInStore> boolean </EligibleForPickupInStore>';
		$requestXmlBody .= '    </PickupInStoreDetails>';
		...
		$requestXmlBody .= '<PayPalEmailAddress>sandbox_david@laptop-parts.biz</PayPalEmailAddress>';
		...
		$requestXmlBody .= '        <WeightMajor unit="lbs">5</WeightMajor>';
		$requestXmlBody .= '        <WeightMinor unit="oz">2</WeightMinor>';
		$requestXmlBody .= '      </CalculatedShippingRate>';
		$requestXmlBody .= '      <PaymentInstructions>Payment must be received within 7 business days of purchase.</PaymentInstructions>';
		$requestXmlBody .= '      <SalesTax>';
		$requestXmlBody .= '        <SalesTaxPercent>7.875</SalesTaxPercent>';
		$requestXmlBody .= '        <SalesTaxState>MN</SalesTaxState>';
		$requestXmlBody .= '      </SalesTax>';
